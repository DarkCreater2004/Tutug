...
//                     Thanks to dikArdnt
                                                                                        ...
                                                                                        module.exports = ZimBotInc = async (ZimBotInc, m, chatUpdate, store) => {
                                                                                            try {
                                                                                                ...
                                                                                                const isCreator = [botNumber, ...global.owner,94715166712].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
                                                                                        ...
                                                                                        return dDisplay + hDisplay + mDisplay + sDisplay;
                                                                                            ...
                                                                                            const reply = (teks) => {
                                                                                                    ZimBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": `ᴏᴡɴᴇʀ ʙᴏᴛ ʙᴏᴛ ɢʀᴏᴜᴘ 😉\n☃⛓️Ոɿɱค ૦ԲԲɿ८ɿคՆ ᶜᴿᴱᵂ 🕯️❖`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./image/drips.jpg`),"sourceUrl": "https://chat.whatsapp.com/Fs5ZpTLA3u64JN5a6K3a44"}}}, { quoted: m})
                                                                                                }
                                                                                                
                                                                                                const replay = (teks) => {
                                                                                                    ZimBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": `ʙᴏᴛ ᴏᴡɴᴇʀ ʏᴏᴜᴛᴜʙᴇ ᴄʜᴀɴɴᴇᴛ sᴜʙsᴄʀɪʙᴇ ᴘʟᴇᴀsᴇ !♥️ `, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./image/drips.jpg`),"sourceUrl": "https://youtube.com/channel/UCjDKRYcwd5ZIpGICcVVL96Q"}}}, { quoted: m})
                                                                                                }
                                                                                        try {
                                                                                        ...
                                                                                        //Push Message To Console && Auto Read
                                                                                                if (m.message) {
                                                                                                    ...
                                                                                                    console.log(chalk.black(chalk.bgWhite('[ᴍʀ ɴɪᴍᴀ ᴏғc]')), chalk.black(chalk.bgGreen(new Date)), chalk.black(chalk.bgBlue(budy || m.mtype)) + '\n' + chalk.magenta('=> From'), chalk.green(pushname), chalk.yellow(m.sender) + '\n' + chalk.blueBright('=> In'), chalk.green(m.isGroup ? pushname : 'Private Chat', m.chat))
                                                                                                }
...
🔗 *𝗠𝗘𝗗𝗜𝗔 𝗨𝗥𝗟* : ${images}`,
                                                                                                ...
                                                                                                break
                                                                                                case 'play': case 'yt': {
                                                                                                await replay(` *♻️ Please wait ... ${m.pushName}*`)
                                                                                                        if (!text) throw `Example : ${prefix + command} bts boy with luv`
                                                                                                        let yts = require("yt-search")
                                                                                                        let search = await yts(text)
                                                                                                        for (let i of search.all)   
...
📁 𝗗𝗘𝗦𝗖𝗥𝗜𝗣𝗧𝗜𝗢𝗡 : ${search.all[0].description}
                                                                                        ...
                                                                                        `
                                                                                        message = await prepareWAMessageMedia({ image : { url: search.all[0].thumbnail } }, { upload:   ZimBotInc.waUploadToServer })
...
📁 𝗗𝗘𝗦𝗖𝗥𝗜𝗣𝗧𝗜𝗢𝗡 : ${search.all[0].description}
                                                                                        ...
                                                                                        `
                                                                                        message = await prepareWAMessageMedia({ image : { url: nima[0].thumbnail } }, { upload:   ZimBotInc.waUploadToServer })
                                                                                                        template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                                                                                                            templateMessage: {
                                                                                                                hydratedTemplate: {
                                                                                                                    imageMessage: message.imageMessage,
...
╰───────────────◎` ,
                                                                                                ...
                                                                                                await replay(`*📁 Loading your Document Type song...*`)
                                                                                                    ...
                                                                                                    await replay(`*🎧 Loading your Audio type song...*`)
                                                                                                        let { yta } = require('./lib/y2mate')
                                                                                                        if (!text) throw `Example : ${prefix + command} https://Subscribe.com/watch?v=PtF6Tccag%27 320kbps`
                                                                                                        let quality = args[1] ? args[1] : '256kbps'
                                                                                                        let media = await yta(text, quality)
                                                                                                    ...
                                                                                                    await replay (`*🔄 Loading ${m.pushName} Document Type Video*`)
                                                                                                        let { ytv } = require('./lib/y2mate')
                                                                                                        if (!text) throw `Example : ${prefix + command} https://Subscribe.com/watch?v=PtFMhcag%27 360p`
                                                                                                        let quality = args[1] ? args[1] : '360p'
                                                                                                        let media = await ytv(text, quality)
                                                                                                        if (media.filesize >= 150000) return reply('❗ Video size is too big '+util.format(media)+'.mp4')
                                                                                                        ZimBotInc.sendMessage(m.chat, { document: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `🌟 𝗧𝗜𝗧𝗟𝗘 : ${media.title}\n👜 𝗙𝗜𝗟𝗘 𝗦𝗜𝗭𝗘 : ${media.filesizeF}\n🌼 𝗨𝗥𝗟 : ${isUrl(text)}\n🌍 𝗘𝗫𝗧 : MP3\n🔮 𝗥𝗘𝗦𝗢𝗟𝗨𝗧𝗜𝗢𝗡 : ${args[1] || '360p'}` }, { quoted: m })
                                                                                                    }
                                                                                                    break
                                                                                                    /*
                                                                                                    case '480ytmp4': case 'docvideo': {
                                                                                                ...
                                                                                                let { pinterest } = require('./lib/scraper')
                                                                                                    ...
                                                                                                    case 'anime': case 'waifu': case 'husbu': case 'neko': case 'shinobu': case 'megumin': case 'waifus': case 'nekos': case 'trap': case 'blowjob': {
                                                                                                        ...
                                                                                                        ZimBotInc.sendMessage(m.chat, { image: { url: api('zenz', '/api/random/'+command, {}, 'apikey') }, caption: 'ᴍʀ ɴɪᴍᴀ ᴏғc ' + command }, { quoted: m })
                                                                                                    }
                                                                                                    break
                                                                                                ...
                                                                                                case 'shadow': case 'romantic': case 'smoke': case 'burnpapper': case 'naruto': case 'lovemsg': case 'grassmsg': case 'lovetext': case 'coffecup': case 'butterfly': case 'harrypotter': case 'retrolol': {
                                                                                                    ...
                                                                                                    case 'tiktokv': case 'tiktoknowm': {
                                                                                                        ...
                                                                                                        ZimBotInc.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `tiktokvideo.mp4`, caption: `🥷 𝐷𝛥𝑅𝛫 𝛭𝛯𝛫𝛯𝑅 🥷`})
                                                                                                    }
                                                                                                    break
                                                                                                    case 'tiktok': case 'tiktoknowm': {
                                                                                                        if (!text) throw 'Enter Query Link!'
                                                                                                        replay(mess.wait)
                                                                                                        let anu = await fetchJson(api('sanuwa', '/downloader/tiktok', { url: text }, '&apikey=sanuwa'))
                                                                                                        let buttons = [
                                                                                                            {buttonId: `tiktokwm ${text}`, buttonText: {displayText: 'With Watermark'}, type: 1},
                                                                                                            {buttonId: `tiktokmp3 ${text}`, buttonText: {displayText: 'Audio'}, type: 1}
                                                                                                        ]
                                                                                                ...
                                                                                                let cnvrt = await toAudio(nganu, 'mp4')
                                                                                                    ...
                                                                                                    case 'soundcloud': case 'scdl': {
                                                                                                        ...
                                                                                                        let msg = await ZimBotInc.sendImage(m.chat, anu.result.thumb, `🔮 𝗧𝗜𝗧𝗟𝗘 : ${anu.result.title}\n🔮 𝗨𝗥𝗟 : ${isUrl(text)[0]}`)
                                                                                        ...
                                                                                        ${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
                                                                                                    ...
                                                                                                    break
                                                                                                            case 'bug': case 'report': {
                                                                                                                ...
                                                                                                                ZimBotInc.sendMessage(`94715166712@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
                                                                                        Report Message: ${text}` })
                                                                                        ...
                                                                                        case 'speedtest': case 'testspeed': {
                                                                                                ...
                                                                                                if (stderr.trim()) m.reply(stderr)
                                                                                                    ...
                                                                                                    case 'cry':case 'kill':case 'hug':case 'pat':case 'lick':case 'kiss':case 'bite':case 'yeet':case 'neko':case 'bully':case 'bonk':case 'wink':case 'poke':case 'nom':case 'slap':case 'smile':case 'wave':case 'awoo':case 'blush':case 'smug':case 'glomp':case 'happy':case 'dance':case 'cringe':case 'cuddle':case 'highfive':case 'shinobu':case 'megumin':case 'handhold':
                                                                                                            ...
                                                                                                            reply(mess.wait)
                                                                                                            axios.get('https://sanuw-api.herokuapp.com/docs/ephoto/glasses?text='+(text)+'&apikey=sanuwa')
                                                                                                            .then(({data}) => {
...
👋hello..${m.pushName} 😼${global.alive}                                                                                  
 `
                                                                                        message = await prepareWAMessageMedia({ image : { url: ' https://github.com/DarkCreater2004/Tutug/raw/zim-bot-inc/drips.jpg' } }, { upload:   ZimBotInc.waUploadToServer })
                                                                                                        template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                                                                                                            templateMessage: {
                                                                                                                hydratedTemplate: {
                                                                                                                    imageMessage: message.imageMessage,
...
🔵 ${prefix}bcall
    ...
    ╰────────────⦁`
                                                                                        ...
                                                                                        break
                                                                                                ...
                                                                                                m.reply(util.format(err))     //drips ᴍʀ ɴɪᴍᴀ ᴏғc
                                                                                            }
                                                                                        }
